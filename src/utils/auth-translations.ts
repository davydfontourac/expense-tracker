export const AUTH_TRANSLATIONS: any = {
  'pt-BR': {
    ...
    register: {
      ...
      reqLen: 'Digite sua senha',
      reqUpper: 'Uma letra maiúscula',
      reqNum: 'Pelo menos um número',
      reqSymbol: 'Pelo menos um símbolo',
      reqSuccess: 'Senha excelente',
      ...
      errors: {
        ...
        passwordLower: 'Deve conter pelo menos uma letra minúscula',
        passwordNum: 'Deve conter pelo menos um número',
  ...
  'en': {
    ...
    register: {
      ...
      errors: {
        ...
        passwordNum: 'Must contain at least one number',
