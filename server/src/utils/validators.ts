...
export const createTransactionSchema = z.object({
  ...
  date: z.string().refine((val) => !Number.isNaN(Date.parse(val)), { message: 'Data inválida.' }),
...
export const updateTransactionSchema = z.object({
  ...
  date: z.string().refine((val) => !Number.isNaN(Date.parse(val)), { message: 'Data inválida.' }).optional(),
  category_id: z.string().uuid('ID de categoria inválido.').optional().nullable(),
