    ...
    <div className="mock">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '220px 1fr', minHeight: 500 }}>
        ...
        >
          ...
          >
            <img
              src="public/logo-expense-tracker.png"
              alt=""
          ...
          >
            <div
              style={{ fontFamily: 'Geist Mono, monospace', color: 'var(--ink-400)', fontSize: 10 }}
            >
              OUTUBRO 2026
            </div>
            <div style={{ marginTop: 4, fontSize: 12, color: 'var(--ink-900)', fontWeight: 500 }}>
              Filtro ativo
            </div>
          </div>
        </aside>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }}>
            <div>
              ...
              <div style={{ fontSize: 12, color: 'var(--ink-500)', marginTop: 4 }}>
                Você gastou <b style={{ color: 'var(--ink-900)' }}>R$ 1.292,83</b> em abril · 41% da
                sua receita
              </div>
            </div>
                    ...
                    >
                      <div
                        style={{
                          ...
                          background: i === 3 ? 'var(--brand-500)' : 'var(--ink-900)',
                        }}
                      />
                      <div
                        style={{
                          flex: 1,
                          height: Math.max(10, h * 0.45) + '%',
                          borderRadius: '3px 3px 0 0',
                          background: i === 3 ? 'rgba(99,102,241,0.25)' : 'var(--ink-200)',
                        }}
                      />
                    </div>
                    <div
                ...
                >
                  {[
                    ...
                    >
                      ...
                      <span
                        style={{ fontFamily: 'Geist Mono, monospace', color: 'var(--ink-500)' }}
                      >
                        {p}
                      </span>
                    </div>
    ...
    csv: (
      ...
      >
        ...
        <div style={{ marginTop: 6 }}>
          ...
          <span style={{ color: '#a78bfa' }}>→ Alimentação</span>
        </div>
        <div>
          <span style={{ color: '#22d3ee' }}>04/10</span> UBER TRIP{' '}
          <span style={{ color: '#a78bfa' }}>→ Transporte</span>
        </div>
        <div>
          <span style={{ color: '#22d3ee' }}>07/10</span> NETFLIX{' '}
          <span style={{ color: '#a78bfa' }}>→ Assinaturas</span>
        </div>
      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <ul>
              {t.footer.links.product.map(([l, h]) => (
                <li key={l}>
                  <a href={h}>{l}</a>
                </li>
              ))}
          ...
          <div className="footer-col">
            ...
            <ul>
              {t.footer.links.company.map(([l, h]) => (
                <li key={l}>
                  <a href={h} target={h.startsWith('http') ? '_blank' : undefined} rel="noopener">
                    {l}
                  </a>
                </li>
              ))}
          ...
          <div className="footer-col">
            ...
            <ul>
              {t.footer.links.resources.map(([l, h]) => (
                <li key={l}>
                  <a href={h}>{l}</a>
                </li>
              ))}
...
function App() {
  ...
  return (
    <div
      data-theme={tw.dark ? 'dark' : 'light'}
      style={{
        background: tw.dark ? '#07070f' : 'white',
        color: tw.dark ? '#e8e8f0' : 'var(--ink-900)',
        minHeight: '100vh',
      }}
    >
      <style>{STYLE}</style>
      <Nav
        ...
        t={t}
        isDark={tw.dark}
        onToggleDark={() => setTweak('dark', !tw.dark)}
      />
      <Hero t={t} />
      <Problems t={t} />
      <Features t={t} />
